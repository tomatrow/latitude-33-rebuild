...
<div class="{clazz} relative flex items-center flex-col justify-center sm:pt-8 lg:pt-0">
    ...
    <img
        class=" sm:max-h-64 sm:max-w-[26rem] w-full lg:max-h-full sm:w-auto"
        use:classes={[
            float &&
    ...
    {#if image?.caption}
        <span
            ...
            class="bg-opacity-80 max-w-[26rem] absolute sm:static right-0 bottom-0 left-0 m-2 sm:my-4 mx-auto p-2 sm:p-4 text-sm"
