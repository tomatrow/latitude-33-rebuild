...
<div class="{clazz} lg:flex lg:items-start lg:justify-center">
    ...
    <img class="border-opacity-80 mx-auto lg:mx-0 w-full max-w-sm border border-white" {...image} />
    ...
    >
        <Heading reverse class="text-sarcastic-orange" {subheading}
            ><span class="text-black">{title}</span></Heading
        >
